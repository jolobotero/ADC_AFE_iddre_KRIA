...
HD_PWD='D:/P_vhdl_Vi/ADC_AFE_iddre_KRIA/ADC_AFE_iddre_KRIA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KRIA_IDDRE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KRIA_IDDRE.tcl -notrace
