...
HD_PWD='D:/P_vhdl_Vi/ADC_AFE_iddre_KRIA/ADC_AFE_iddre_KRIA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KRIA_IDDRE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KRIA_IDDRE.tcl
